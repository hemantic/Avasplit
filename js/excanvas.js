...
(function() {
  ...
  contextPrototype.drawImage = function(image) {
    ...
    // Apply scales to width and height
    vmlStr.push('<div class="excanvas_new_image" style="background:silver; width:', Math.round(scaleX * w * dw / sw), 'px;',
	...
	// RTAC 20/02/2010 - somehow this stops the flicker at the start... forces render? 
	jQuery('.excanvas_new_image').css('display', 'block').removeClass('excanvas_new_image');
  };
